...
function be_schema_engine_render_schema_preview_selector() {
    ?>
...
function be_schema_engine_render_schema_preview_criteria() {
    ?>
...
function be_schema_engine_render_schema_preview_output() {
    ?>
...
function be_schema_engine_render_schema_tab_preview() {
    ...
    <div class="be-schema-preview-upper">
        ...
        be_schema_engine_render_schema_preview_criteria();
        ?>
    </div>
